...
#hcp_rsfc_data <- read.csv("D:/OneDrive/GraduateStudent_Phd1/4_Population_differences_BrainParcellation/Population_differences_BrainParcellation/8_MSN_GLM_2groups_2nd/SEM/majorRe/pc1_signed/HCPYA_Sleep_z_top100_v1.csv") # OK
hcp_rsfc_data <- read.csv("D:/OneDrive/GraduateStudent_Phd1/4_Population_differences_BrainParcellation/Population_differences_BrainParcellation/8_MSN_GLM_2groups_2nd/SEM/majorRe/pca1_sp10_signed/HCPYA_Sleep_z_top100_v1.csv")# OK
...
sem_model <- '
  ...
  # regressions
    RSFC_mean ~ age + sex + c*group01 + SES + b*sleep  + RMS + ICV
    sleep ~ a*group01 + age +sex + SES + RMS + ICV
